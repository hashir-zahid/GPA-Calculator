...
function GPACalculator() {
  ...
  return (
    <div className="container">
      <h1 className="title">NUML GPA Calculator</h1>
        ...
        <div key={index} className="subject-card">
          ...
          <div className="form-group">
            ...
            <input
              ...
              max={100}
              value={subject.marks}
              onChange={(e) => (e.target.value === '' || (e.target.value >= 0 && e.target.value <= 100)) && handleInputChange(index, e)}
      ...
      {gpa !== null && (
        <div className="gpa-result">
          <h2>Your GPA: {gpa}</h2>
          <p>Based on {subjects.length > 1 ? subjects.length+' subjects' : '1 subject'}</p>
        </div>
      )}
    </div>
  );
